...
#show hisao basic_grin_paj_close with charachange
...
"I'm not sure how long we spend lying like this. Two minutes? Five? Just as I start wondering if this hadn't been a bad idea all along, I feel a sensation on the back of my head."
...
#show hisao basic_emb_paj_close with charachange
...
"After what feels like an hour of petting and caressing, I turn my head to the side. So far Hisao hasn't taken much initiative, content to let me determine the pace - a role I'm slowly growing into."


"Deciding to take another step closer, I lean in and kiss him on his left cheek. For a second there's no reaction, before he unexpectedly turns his head, causing his lips to touch mine and making me pull back with a surprised gasp."

#show hisao basic_surprise_paj_close

"As I get ready to return the kiss, a playful idea gets into my head. I carefully approach his mouth with mine until I can feel his breath tickling my lips, stopping what I think is barely an inch away from his face."

"I quietly count to three in my head and then place an unexpected kiss on his right cheek. As he turns his head again, I swiftly move my head back just a bit so my lips remain just out of his reach."
...
"As I quickly move back again, I hear a soft chuckle. Determined not to let him catch up to me in this little game of tag, I hold my breath to prevent him from tracking me, then swiftly place a kiss on his right cheek again."
...
#show hisao basic_emb_paj_close
...
"I feel him open his mouth just slightly as we press our lips together. When I carefully pull away after kissing his lower lip for several moments, I feel no anxiety or fear, just a little nervousness and more than a little anticipation."
...
"…"
#show hisao basic_pain_paj_close with charachange
...
"Attempt number two then. I do my best to relax and slip my tongue into his mouth again. This time I let his tongue touch mine, though it's mostly passive contact."

"Is there a right way to do this? It looks so easy on television."

"Attempt number three. I try to stroke his tongue with mine a bit. Am I doing this correctly? As I clumsily explore his mouth with my tongue, I feel his hand stroking my back."
...
ha "…g-go a-all the way?"

hi "Yes. Do you…?"

ha "I… I…"

"Part of me would probably like that. But another part of me is still afraid. Afraid of being… penetrated again."

"Afraid of the pain and awkwardness that came with it last time."
...
"Especially considering how much effort he's made this night to adjust things to my pace." 
...
#show hisao basic_sigh_paj_close with charachange

"He sighs. That was to be expected."

hi "I understand Hanako. We've already gotten really far."

"That's the problem. We've gotten this far and now I'm blue balling you. That has to be frustrating."

"Please don't pretend it's not. Please don't pretend to be understanding."
...
"And now you're going to sleep on a dissatisfied note. Or worse, sneak off to the bathroom whenI'm asleep to hand yourself that happy ending I can't give you."
...
#show hisao basic_neutral_paj_close with charachange
...
ha "…I c-could… s-s-stroke y-you… d-d-down t-t-there… m-make you f-f-feel g-good."
...
#show hisao basic_smile_paj_close with charachange

hi "In that case… I'm all yours."

"Yes!"

call en_chapter6_hscene

label en_chapter6_hscene:
...
#show hisao basic_emb_laugh_paj_close with charachange
...
"When I catch my breath, I can hear the rustling of his pajamas as they're being taken off. I softly stroke his leg, and as my hand runs across his boxers, I whisper a final request for confirmation."
...
#scene evhunlock hanako_handjob
#show evh hanako_handjob_normal
...
"The fact that he's naked, vulnerable and leaving himself in my hands (and the fact we can't see each other) gives me enough confidence to take the lead."

"As I start caressing his thighs and hear his breathing accelerate, I suddenly think of something."

"Letting up my kissing, I move my head to the side of his, playfully kiss his earlobe and then whisper in his ear as I place my hand on his chest. His heartbeat is fairly quick, but steady."

ha "Hisao, if you start feeling d-distress or chest pain or… anything alarming, just say stop and I'll stop immediately. That or just pinch my side. Okay? My left side."
...
"Then I wrap my fingers around him. I slowly move my hand, playfully squeezing every now and again."

"As he starts moving his body in tandem with my motions, I start speeding up."
...
"I can tell by the movement of his hips, his breathing and the occasional stifled groan that he's near his limit. As I prepare to give him a final nudge…"

hi "Stop! Hanako, stop, stop, please…"

"I quickly let go of him and listen as he struggles to catch his breath. Is he going to have an episode? Did I go too far?"
...
ha "P-please don't scare me like that anymore."
...
ha "I am. I really like making you feel good. It f-feels good pampering you. This probably feels as good to me emotionally as it does to you physically. Both types of fun are rewarding."
...
hi "By leaving things up to you and following your lead. That worked very well before. We can stop any time it becomes too much."

ha "D-do really want to do… this… with me that badly?"
...
"I think for a bit. I can't ignore the fact that I warmed up to making out pretty quickly, despite being nervous about it earlier."

"Would this be the same? Can I do this without freaking out? Hisao entrusted himself to me. I'd like to give him the same level of trust."
...
"His arms wrap around me. I don't feel them on my upper back very well, but the sensation of my chest being pressed against his is all the stronger for it."

"I feel his hand stroke the back of my head. As we lie there, I slowly feel my tension ebb away."
...
"I nod even though I know he can't see it and seek out his lips. I try to speed up my pace a little bit for his sake, and soon we're back to the intense kisses we shared just before I started pleasuring him."
...
"I work my way up to his neck and am pleased to find out Hisao's hand follows suit. Looks like I found anew way to guide him."
...
"This time, it's much stronger, and I reel from each sensation his hand sends through my abdomen. I'm getting so absorbed in the experience that I almost miss him calling out to me."
...
ha "D-do you… hahh… want to take a…a break, Hisao?"
...
"He playfully licks my earlobe. That's more than I can take."

"My body makes a bucking motion, my hips tense up and I feel three… four shocks between my legs, each of them sending a delightful shudder up my spine."

"I squeeze my lips shut, but can't prevent myself from letting out several stifled moans."

"As my climax subsides, I become aware of Hisao again who's still rapidly thrusting his hips. Eager to let him follow suit, I increase the pace of my strokes even more and gently lick his neck."

"Suddenly, I hear a muffled groan followed by the sensation of something wet hitting my belly."

"Hisao's body relaxes and slumps against me. For a moment, all that's audible in the room is the sound of our heavy breathing."

"…"

call en_chapter6_contd

label en_chapter6_contd:

scene bg hok_bedroom onlayer master with locationchange

play music music_twinkle fadein 2.0

#show hisao basic_smile_naked_close with charaenter
...
"He pulls the sheets back up, and I snuggle up against him."

"Laying my head on his chest, I can hear hisheartbeat. Still swift, but steady."

"I sigh contentedly as he puts his arm around me and strokes my head once more."
...
"I think he was just being polite there. How long did this whole thing take?"

"And how many guys would really want to do the long-winded approach of one baby step at a time until their girlfriend would finally manage to keep her nerves in check?"

"I don't have any personal experience, but I'm pretty sure most guys would get bored with the slow pace and get the desire to quickly skip to the end."

"It makes me appreciate Hisao all the more."

"Tomorrow morning will probably be very awkward, but I promise myself to wake him up with a smile tomorrow."

"Hisao's breathing has already changed to the slow and steady rhythm of slumber, and just before I join him, one final though goes through my mind."

"Just before he nudged me over the edge, for only a single second, I wanted to go further… wanted him to go further."

"I smile. With luck, it won't be too long before I'm ready to take another step with him."
