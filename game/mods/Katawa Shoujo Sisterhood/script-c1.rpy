...
n "It has been a little over a week since Akira and I arrived at our parents' home, and although the official reason for coming over was seeing (or perhaps seeing off, though her situation miraculously stabilized shortly before our arrival) Mother's ailing sister, our whole time here has felt more like a vacation."

n "I have spent most of our time here sitting in the backyard reading the books I brought along and occasionally chatting with Akira."

n "After finishing the remainders of breakfast that were left in the kitchen for me (Mother and Father appear to be early risers; I wonder what side of the family I take after), I navigate my way to the yard hoping for an opportunity to catch a few rays." 

n "As I step outside, I'm greeted by the familiar sound of a sharp snap followed by the short hiss of a beer can being opened."

n "I turn my head towards the source of the sound and do my best to appear as disapproving as I can."

show akira basic_smile onlayer master at center
with charaenter
...
show akira basic_boo onlayer master with charachange

aki "Hey, unlike you I've been up and about for four hours already. Besides, I have a reason to celebrate. Check out what I got this morning."
...
show akira basic_laugh onlayer master with charachange

aki "Not just that. I managed to convince the old man to let us fly business class! We'll be travelling back in STYLE, BABY!!!"
...
show akira basic_resigned onlayer master with charachange

"The playful retort I was expecting doesn't come. Uncomfortable silences aren't exactly common around Akira. Did I misjudge her yesterday evening?"

show akira basic_smile onlayer master with charachange

aki "Why don't we have a little walk, Sis? A little stroll by the bay shore'll do you good."

scene bg shizu_fishing with locationchange
...
"I sigh. I didn't really think it was my place to tell Akira what to do with her life, especially not after she sacrificed the latter part of her youth to look after me."
...
"And within a week, she'll be back in Japan breaking up a relationship that she seemed happy with before."
...
"I nod silently. She may not seem like it at first impression, but Akira's pretty ambitious."

"And there are still several rungs of the corporate ladder left that she wants to climb."

show akira basic_lost onlayer master with charachange
...
aki "Better to get this step behind me before my good looks start fading. Not everybody makes a big deal out of looks."

"We both get a good laugh out of that. I suddenly feel how she takes my hand and pushes a small flat rock into it before turning me around."
...
show akira basic_annoyed onlayer master with charachange
...
"Akira suddenly sounds very bitter. I cringe a bit at her sudden change of tone. I've never really felt comfortable when she vented about our parents, but I've never denied her a chance to do so, even though my own feelings are more nuanced."
...
aki "Whaddayathink? Word of my recommendation already spread around. You really think my job won't hit a dead end if I decline?"
...
li "This is why I hate the notion of office politics. I cannot even begin to imagine how I would feel in that kind of situation."

play sound "sfx/snap.ogg"

"I stifle a cry as Akira gives me a cheerful slap on the back."

aki "Probably like a goldfish in a shark tank. Stick with your own dream, Lils. You'll thank yourself later."
...
aki "Something like that. He knows I want to work my way up. If I give it all up for his sake, I'll probably end up resenting him over it, even if the decision was completely my own."
aki "No relationship can survive with that kinda baggage. I think he'll understand. I hope he'll understand. Anyway, let's start walking back."
...
"I am impressed. Akira wasn't the only one who was asked to move from Japan to Scotland. I too have been asked to move back in with our parents."

"But where she accepted almost immediately, I have been trying to avoid even thinking about the choice that has been offered to me."
...
aki "But since I made my own decision right in front of you, I probably influenced your choice already and that felt kinda wrong. I probably could've shut up and let you figure out what to do for yourself."
...
aki "And I'm not referring to that competitive cousin of ours with whom you get along so well."

"I sigh. Akira is correct, unfortunately. When Mother and Father told me they liked me to move to Scotland and live with them again, Hanako and Hisao were the first thought that came to my mind."
...
show akira basic_ending onlayer master with charachange
...
"It takes me a moment to place Hanako's tone. While I've known Hanako for about a year and have been around during her good moods, this is the first time in a long while she's sounding outright cheerful."
...
"I have no doubt that whatever she wants to tell me is responsible for the good mood she's currently in, and I'm not looking forward to spending several more days wondering what it might be, so I decide to press the issue a bit."
...
scene bg hok_houseext with locationchange

"By the time Akira and I arrive at the driveway of our parents' mansion, we're both wearing a huge smile on our face. Akira chuckles lightly."

show akira basic_laugh onlayer master with charachange

aki "Hah, I still can't believe she got herself a boyfriend. Who would have known? Didn't think she had it in her."
...
aki "How about I go down to the cellar and fetch us something to celebrate? Wanna open up a little bottle of champagne and perform a toast?"
